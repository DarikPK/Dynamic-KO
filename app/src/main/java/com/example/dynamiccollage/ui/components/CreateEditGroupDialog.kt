        ...
        text = {
            Column(
                ...
                Row(
                    ...
                    Checkbox(
                        checked = editingGroup.verticalAdjustment,
                        onCheckedChange = { viewModel.onEditingGroupVerticalAdjustmentChange(it) }
                    )
                ...
                Row(
                    ...
                    Checkbox(
                        checked = editingGroup.horizontalAdjustment,
                        onCheckedChange = { viewModel.onEditingGroupHorizontalAdjustmentChange(it) }
                    )
                    Text("Ajuste Horizontal")
                }
