...
fun MainScreen(
    ...
    LaunchedEffect(pdfGenerationState) {
        ...
        } else if (pdfGenerationState is pe.pixelcollage.app.viewmodel.PdfGenerationState.Error) {
            val message = (pdfGenerationState as pe.pixelcollage.app.viewmodel.PdfGenerationState.Error).message
    ...
    if (pdfGenerationState is pe.pixelcollage.app.viewmodel.PdfGenerationState.Loading) {
